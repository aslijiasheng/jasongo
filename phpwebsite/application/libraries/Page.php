...
class Page
{
    ...
    function __construct($arr = array()){  
        ...
        $this->myde_count=empty($myde_count) ? $this->myde_count:$this->numeric($myde_count);
        $this->myde_size=empty($myde_size) ? $this->myde_size:$this->numeric($myde_size);
        $this->myde_page=empty($myde_page) ? $this->myde_page:$this->numeric($myde_page);
        $this->page_limit=($this->myde_page * $this -> myde_size) - $this -> myde_size; //下一页的开始记录 
        // $this->page_limit<0 ? 0 :  $this->page_limit;
        if( $this->page_limit<0){
            $this->page_limit=0;
        }
        $this->page_url=$page_url; //连接的地址 
        //$this->page_url=empty($page_url) ? $this->page_url:$page_url;
    ...
    return "    <li class=\"page_a\"><a href=\"".$this -> page_replace(1)."\" title=\"首页\" >首页</a></li>\n";   
        ...
        return "    <li class=\"disabled\"><a href=\"".$this -> page_replace(1)."\" title=\"首页\" >首页</a></li>\n";   
    }
    } 
    ...
    return "    <li class=\"page_a\"><a href=\"".$this -> page_replace($this->myde_page-1) ."\" title=\"上一页\" >上一页</a></li>\n";
        ...
        return "    <li class=\"disabled\"><a href=\"".$this -> page_replace($this->myde_page-1) ."\" title=\"上一页\" >上一页</a></li>\n";   
    }
    } 
    ...
    { 
        ...
        { 
            return "    <li class=\"disabled\"><a href=\"".$this -> page_replace($this->myde_page+1) ."\" title=\"下一页\" >下一页</a></li>\n";   
        }
    } 
    private function myde_last() //尾页
    {
        if($this -> myde_page != $this -> myde_page_count){ 
            ...
            return "    <li class=\"disabled\"><a href=\"".$this -> page_replace($this -> myde_page_count)."\" title=\"尾页\" >尾页</a></li>\n";   
        }
    } 
    ...
    {
        $str = "<div id=\"".$id."\" class=\"pages\">\n <ul>\n "; 
        $str .= "<li><span>总记录:".$this -> myde_count."</span></li>\n"; 
        // $str .= "<li><span>".$this -> myde_page."</span>/<span>".$this -> myde_page_count."</span></li>\n"; 
        $str .= $this -> myde_home(); //调用方法，显示“首页”
        $str .= $this -> myde_prev(); //调用方法，显示“上一页”
        //以下显示1,2,3...分页
        for($page_for_i=$this->page_i;$page_for_i <= $this->page_ub;$page_for_i++){ 
            if($this -> myde_page == $page_for_i)
            {   
                $str .= "<li class=\"disabled\"><a href=\"".$this -> page_replace($page_for_i)."\" title=\"第".$page_for_i."页\">";    
                $str .= $page_for_i . "</a></li>\n";    
            }   
            else{   
                $str .= "<li class=\"page_a\"><a href=\"".$this -> page_replace($page_for_i)."\" title=\"第".$page_for_i."页\">";    
