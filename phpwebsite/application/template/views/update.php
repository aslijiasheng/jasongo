...
<!--lee 内容部分 start-->
<div class="grid-view">
	<form class="form-horizontal" id="department-form" action="<?php if(!isset($_GET['type_id'])){echo site_url('www/{#obj_name#}/update?{#obj_name#}_id='.$_GET['{#obj_name#}_id']);}else{echo site_url('www/{#obj_name#}/update?{#obj_name#}_id='.$_GET['{#obj_name#}_id'].'&type_id='.$_GET['type_id']);}?>" method="post">
