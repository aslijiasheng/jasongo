...
<div style="position: fixed; z-index: 2147483647;" title="Scroll to top" id="scrollUp">回到<br>顶部</div>
	...
	<script type="text/javascript" src="<?php echo base_url();?>style/admin/js/lee/lee.js" charset="UTF-8"></script>
	<script type="text/javascript" src="<?php echo base_url();?>style/admin/js/jquery.dataTables.js" charset="UTF-8"></script>
</body>
</html>