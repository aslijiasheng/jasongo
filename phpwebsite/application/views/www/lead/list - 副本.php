			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row">
						...
						<div class="col-xs-12">
							<a href="<?php echo site_url("www/lead/add?typeid=91");?>"><button class="btn">
						...
						<div class="col-xs-12">
							...
							<div class="well well-sm">
								<?php foreach($SearchLabels as $k => $v) {?>
									<label for=<?php echo $k?>><?php echo $v?>
										<input type="text" name="<?php echo $k;?>"/>
									</label>
								<?php }?>
								<button id='lead_sale_search' class="btn btn-primary">
									<i class="ace-icon fa fa-pencil align-top bigger-125"></i>
									查询
								</button>
							</div>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				var url = "<?php echo base_url();?>index.php/www/lead/list_json";
				...
				//jQuery(grid_selector).jqGrid('navGrid','#grid-pager',{edit:false,add:false,del:false});
