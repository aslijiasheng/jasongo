...
<div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><?php echo $lead_data[$OBJ_NAME.'.Name'];?></li>
        </ul><!-- /.breadcrumb -->
    ...
    <div class="page-content">
        ...
        <div class="page-header">
            <h1>
                <?php echo $lead_data[$OBJ_NAME.'.Name'];?>
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="col-xs-12">
                    ...
                    <?php foreach($but_array as $k=>$v){
                        if( $obj_type != 1 && $obj_type != 3){
                                if($k == 6 ||$k == 7 ){
                                continue;
                            }
                        }else{
                            if($lead_data[$OBJ_NAME.".StopFlag"] == 1){
                                if($k == 6){
                                    continue;
                                }
                            }else{
        ...
        <div class="hr hr-dotted hr-16"></div>
        <div id="object_list_view"></div>
        <script type="text/javascript">
            var url = '<?php echo site_url('www/objects/object_list_view');?>'
            var params = {id:'<?php echo $lead_data[$module['KEY_ATTR_NAME']]?>',obj_type:'<?php echo $obj_type;?>',type_id:'<?php echo $lead_data[$module['OBJ_NAME'] . ".TypeID"]?>'};
            $("#object_list_view").AjaxHtml({
                Url:  url,
                Data: params
            });
        </script>
