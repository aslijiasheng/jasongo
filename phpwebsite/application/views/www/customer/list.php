...
$(document).ready(function(){
    $.post("<?php echo base_url(); ?>index.php/www/customer/list_object_json",{},function(data){
        var ret = eval("("+data+")");
        jqgridInit(ret);
    })
})
function jqgridInit(grid_data){
    ...
    $(window).on('resize.jqGrid', function () {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            {name:'uid',index:'uid', width:60, sorttype:"int", editable: true},
            {name:'uname',index:'uname',width:90, editable:true, sorttype:"date"},
        ...
        editurl: "<?php echo base_url(); ?>index.php/www/customer/oper",
        caption: "客户基础信息列表"
