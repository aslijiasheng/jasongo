					...
					if (this.p.colNames.length !== this.p.colModel.length)
						...
						J = function (c, d, e, g, f) {
							...
							if (b.isXMLDoc(c)) {
								...
								b.isFunction(i.userdata) ? a.p.userData = i.userdata.call(a, c) || {}

								 : b.jgrid.getXmlData(c, i.userdata, true).each(function () {
					...
					if (!0 === this.p.scrollrows && (j = this.rows.namedItem(d).rowIndex, 0 <= j && (e = b(this.grid.bDiv)[0].clientHeight, g = b(this.grid.bDiv)[0].scrollTop, h = b(this.rows[j]).position().top, j = this.rows[j].clientHeight, h + j >= e + g ? b(this.grid.bDiv)[0].scrollTop = h - (e + g) + j + g : h < e + g && h < g && (b(this.grid.bDiv)[0].scrollTop = h))), !0 === this.p.frozenColumns && (i = this.p.id + "_frozen"), this.p.multiselect) {
						if (this.setHeadCheckBox(!1), this.p.selrow =
							...
							b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, e, c)
									...
									"aria-selected" : "true",
									tabindex : "0"
								}), i && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).addClass("ui-state-highlight")), e = !0) : e = !1, this.p.selrow = a.id, f))
						b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, e, c)
			})
		},
						...
						if (this.search) {
							...
							case "custom":
								...
								try {
									...
									"e2" === t ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.novalue,
	...
	a.extend(a.jgrid, {
		...
		createEl : function (d, b, c, g, e) {
			...
			case "select":
				...
				d = !1;
				if (void 0 !== b.dataUrl)
					d = b.name ? ("" + b.id).substring(0, ("" + b.id).length - ("" + b.name).length - 1) : "" + b.id, g = b.postData || e.postData, i.p && i.p.idPrefix ? d = a.jgrid.stripPref(i.p.idPrefix, d) : g = void 0, a.ajax(a.extend({
							url : b.dataUrl,
							type : "GET",
							dataType : "html",
					...
					var n,
					k,
					l = void 0 === b.separator ? ":" : b.separator,
		...
		saveRow : function (c, b, e, o, l, g, n) {
			...
			if ("1" === h) {
						...
						case "custom":
							try {
								...
								"e1" === e && a.jgrid.info_dialog(a.jgrid.errors.errcap,
									"function 'custom_value' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose),
				...
				if ("clientArray" === f.url) {
					...
					a("#lui_" + a.jgrid.jqID(d.p.id)).show(), r = a.extend({}, i, r), r[p] = a.jgrid.stripPref(d.p.idPrefix, r[p]), a.ajax(a.extend({
							url : f.url,
					...
					if (null !== c) {
						...
						case "custom":
							try {
								...
								"e2" === o ? b.jgrid.info_dialog(b.jgrid.errors.errcap, "function 'custom_value' " + b.jgrid.edit.msg.novalue,
	...
	d.jgrid.extend({
		...
		groupingRender : function (b, g) {
			return this.each(function () {
				...
				k,
				l,
				j = e.groupCollapse ? e.plusicon : e.minusicon,
				m,
				q = [],
			...
			for (var g = function (a) {
				...
				if (1 === a.nodeType) {
					...
					for (h = 0; h < a.attributes.length; h += 1)
						b += " " + a.attributes[h].nodeName + '="' + (a.attributes[h].nodeValue || "")
							.toString() + '"';
						if (a.firstChild) {
							b += ">";
